...
export class EmailWorker {
    ...
    async sendEmail(job: Job) {
        ...
        try {
            ...
            const template = await this.channelService.getNotificationTemplate('EMAIL', 'EMAIL');
            ...
            this.logger.log(`Email sent to ${email} for notification ${notificationId}`);
            return { success: true };
        } catch (error) {
            this.logger.error(`Email failed for notification ${notificationId}:`, error);
